...
ndiv.setAttribute("class", "paragraph");
div.append(ndiv);
...
ndiv.append(breaker2);

let para3 = document.createElement("p");
para3.setAttribute("id", "email");
ndiv.append(para3);

var breaker4 = document.createElement("br");
ndiv.append(breaker4);

let div3 = document.createElement("div");
div3.setAttribute("class", "btn");
div3.innerHTML = `<button class="prev-btn btn-primary">Prev</button>
...
nBtn.addEventListener("click", () => {
    if (currentItem == data.length) {
        currentItem = 0;
        id.innerHTML = data[currentItem].id;
        name1.innerHTML = data[currentItem].name;
        email.innerHTML = data[currentItem].email;
    } else {
        currentItem++;
        id.innerHTML = data[currentItem].id;
        name1.innerHTML = data[currentItem].name;
